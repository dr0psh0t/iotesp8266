...
const char* ssid = "Wifi_Central";
const char* password = "(---WifiCentral---)";
...
// no offset
//192.168.1.149
NTPClient timeClient(ntpUDP, "192.168.1.149", GMT_8);
...
void inithttp() {
  Serial.println("=== inithttp() ===");
	...
	if(WiFi.status()== WL_CONNECTED) {   //Check WiFi connection status
		http.begin("http://192.168.1.149:8080/joborder/IoTCheckWorkQueue");		//Specify destination for HTTP request
