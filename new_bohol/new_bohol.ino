...
// no offset
NTPClient timeClient(ntpUDP, "192.168.2.155", GMT_8);
...
void inithttp() {
  Serial.println("=== inithttp() ===");
	...
	if(WiFi.status()== WL_CONNECTED) {   //Check WiFi connection status
		http.begin("http://192.168.2.155:8080/joborder/IoTCheckWorkQueue");    //Specify destination for HTTP request
